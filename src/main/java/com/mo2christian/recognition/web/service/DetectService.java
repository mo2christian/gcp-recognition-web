 ...
 */
public class DetectService extends SSLValidator implements ApiKey {
    ...
    public DetectResponse detectLabel(DetectRequest request){
        ...
        ResponseEntity<String> resp = restTemplate.postForEntity(host, entity, String.class);
